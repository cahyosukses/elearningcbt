...
if($_GET['aksi']==""){
$hasil = $koneksi_db->sql_query( "SELECT * FROM kursus_setting  order by guru asc" );
...
$hasil  = mysql_query( "update `ujian` set pertemuan='$pertemuan',tgl = '$tgl',judul = '$judul',tipe = '$tipe',status='$status',jumlahsoal='$jumlahsoal',pointbenar='$pointbenar',pointsalah='$pointsalah',pointkosong='$pointkosong',petunjuk='$petunjuk',tipeujian='$tipeujian' where id='$id'" );
if($hasil){
...
if($getkelasid_ks==""){
$admin .= '<div class="error"><b>Tidak dapat Menambah Data Karena kelas Kosong.</b></div>';
}else{
$admin .='<div class="panel-heading"><b>Nama Kursus</b> </div>';
...
$test = '<a href="?pilih=ujian&amp;mod=yes&amp;aksi=testujian&amp;idujian='.$data['id'].'&amp;id='.$idkursus.'"><span class="btn btn-primary">Test</span></a>';
//$test = '<a href="?pilih=ujiantest&amp;mod=yes&amp;idujian='.$data['id'].'&amp;id='.$idkursus.'"><span class="btn btn-primary">Test</span></a>';
}else{
$test = '';
}
$admin .='
<td><a href="?pilih=ujian&amp;mod=yes&amp;aksi=del&amp;id='.$data['id'].'&amp;idkursus='.$idkursus.'" onclick="return confirm(\'Soal pada ujian tersebut akan ikut terhapus,Apakah Anda Yakin Ingin Menghapus Data Ini ?\')"><span class="btn btn-danger">Del</span></a>&nbsp;<a href="?pilih=ujian&amp;mod=yes&amp;aksi=edit&amp;id='.$data['id'].'&amp;idkursus='.$idkursus.'" onclick="return confirm(\'Edit Ujian hanya mengedit Tipe Soal Urut/Random dan Status Ujian, Apakah ingin melanjutkan ?\')"><span class="btn btn-warning">Edit</span></a>&nbsp;<a href="?pilih=ujian&amp;mod=yes&amp;aksi=addsoal&amp;idujian='.$data['id'].'&amp;id='.$idkursus.'"><span class="btn btn-success">Soal</span></a>&nbsp;'.$test.'</td>
</tr>';
$no++;
}
$admin .= '</tbody></table>';
...
$files=$data['files'];
if($files){
$gambar = '<a href="mod/ujian/download/'.$files.'" target="new" class="label label-success" rel="lightbox[roadtrip]">available</a>&nbsp;<a href="?pilih=ujian&amp;mod=yes&amp;aksi=hapusfilessoal&amp;idujian='.$idujian.'&amp;id='.$idkursus .'&amp;idsoal='.$idsoal .'"class="label label-danger">hapus</a>' ;
}else{
...
<table cellspacing="0" cellpadding="0"class="table table-striped table-hover">
	...
	<tr>
		...
		<td></td>
		<td>';
$admin .= '<a href="./downloaddoc.php?idujian='.$idujian.'&amp;id='.$idkursus.'"><span class="btn btn-primary">Download DOC</span></a>';
$admin .= '</td>
	</tr>
	'.$petunjukumum.'
</table>';
...
$admin .="<a href='?pilih=ujian&mod=yes&aksi=listujian&id=$idkursus'><span class='btn btn-primary'>BACK</span></a>&nbsp;";
$admin .="<input type='submit'class='btn btn-success' value='Submit' name='submit'>";
$admin.="</div>";
$admin.="<br></form>";
...
$hasil = $koneksi_db->sql_query("SELECT * FROM ujian  ORDER BY guru asc");
