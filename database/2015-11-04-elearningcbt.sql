...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 04, 2015 at 03:40 AM
...
(6, 36, '<p>Diketahui reaksi :<br />CaCO<sub>3</sub> (s)+ 2HCl (aq) &rarr;CaCl<sub>2</sub> (aq)+ H<sub>2</sub>O (l)+ CO<sub>2</sub> (g)<br />Jika 5 gram batu kapur direaksikan dengan asam klorida encer, maka pada keadaan RTP akan diperoleh gas CO<sub>2&nbsp;</sub>sebanyak &hellip;&nbsp;<br />(Ar : Ca = 40 , Cl = 35,5 , O = 16 , C = 12 dan H = 1)</p>', '1,20 dm<sup>3</sup>#2,40 dm<sup>3</sup>#4,80 dm<sup>3</sup>#6,00 dm<sup>3</sup>#12,0 dm<sup>3</sup>', 'a', ''),
...
(8, 36, '<p>Reaksi :</p>\r\n<p>N<sub>2 </sub>(g)+ 3H<sub>2</sub> (g) &hArr;2NH<sub>3</sub> (g)&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>\r\n<p>âˆ†H = &ndash; 22 kkal</p>\r\n<p>Pernyataan di bawah ini yang mengakibatkan pergeseran kesetimbangan ke arah kanan untuk reaksi di atas adalah &hellip;</p>', 'Kenaikan suhu#Pengurangan Tekanan#penambahan volume#penambahan katalis#penurunan suhu', 'e', ''),
...
(11, 36, 'Reaksi berikut : 3Br<sub>2</sub> (g)+ aOH<sup>&ndash;</sup>(aq) &rarr;bBrO<sub>3</sub><sup>&ndash;</sup>(aq) + cBr<sup>&ndash;</sup>(aq) + dH<sub>2</sub>O(l) <br />Harga koefisien a, b, c, d supaya reaksi di atas setara adalah &hellip;', '<span>2, 2, 5 dan 1</span>#6, 1, 5 dan 3#6, 5, 1 dan 3#5, 6, 3 dan 1#4, 1, 5 dan 2', 'b', ''),
(12, 36, '<p>Diketahuipotensialelektroda :</p>\r\n<p>Ag<sup>+</sup>(aq) + e&nbsp; &rarr;Ag(s) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; E<sup>o</sup> = + 0,80 volt</p>\r\n<p>Mn<sup>2+</sup>(aq) + 2e &rarr;Mg(s)&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; E<sup>o</sup> = &ndash; 2,34 volt</p>\r\n<p>In<sup>3+</sup>(aq) + 3e&nbsp; &rarr;In(s) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; E<sup>o</sup> = &ndash; 0,34 volt</p>\r\n<p>Mn<sup>2+</sup>(aq)+ 2e &rarr;Mn(s)&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; E<sup>o</sup> = &ndash; 1,20 volt</p>\r\n<p>Dua set setengah sel di bawahini yang mempunyai nilai E<sup>o</sup>sel = 2 voltadalah .&hellip;</p>', 'Mg | Mg<sup>2+</sup> ||Ag<sup>+</sup> | Ag#Ag | Ag<sup>+</sup> || Mg<sup>2+</sup> | Mg#Mn | Mn<sup>2+</sup> || In<sup>3+</sup> | In#Mn | Mn<sup>2+</sup> || Mg<sup>2+</sup> | Mg#Ag | Ag<sup>+</sup> || In<sup>3+</sup> | In', 'c', ''),
...
(16, '2015-11-04', '5', 'admin', '0'),
(17, '2015-11-04', '5', 'admin', '40');
...
--
-- Dumping data for table `ujiansetting`
--
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Administrator', 'aktif', 1, '2015-11-04 07:27:31', '2010-08-27 00:00:00', '2034-08-27 00:00:00', 'Administrator', '', 'sembunyikan', 'sembunyikan', '', '', '0'),
