...
--
-- Host: 127.0.0.1
-- Generation Time: 12 Mar 2016 pada 11.46
-- Versi Server: 5.6.16
-- PHP Version: 5.5.11
...
(38, 42, 'Semua hasil observasi dalam sosiologi disusun secara sistematis supaya orang yang membaca dapat memahami pemikiran para tokoh atau pemikiran penulis. Hal ini menunjukkan bahwa sosiologi sebagai ilmu pengetahuan memiliki ciri&hellip;.<br /><br />', 'Empiris<br /><br />#Kategoris<br /><br />#Kumulatif<br /><br />#Teoritis<br /><br />#Nonetis', 'd', ''),
(39, 42, 'Dilakukan sebuah penelitian mengenai manfaat sebuah terminal dengan cara melakukan pengamatan sekilas dan wawancara dengan masyarakat sekitar. Metode yang dilakukan untuk mengumpulkan data tersebut adalah&hellip;.<br /><br />', 'Observasi dan dokumentasi<br /><br />#Angket dan observasi<br /><br />#Dokumentasi dan wawancara<br /><br />#Observasi dan wawancara<br /><br />#Dokumentasi dan kuesioner', 'd', ''),
(40, 42, 'Rini seorang pelajar mengadakan suatu riset mendalam untuk mencari solusi atas permasalahan sosial di sekitar tempat tinggalnya. Dalam kasus tersebut, merupakan kegunaan sosiologi dalam&hellip;.<br /><br />', 'Pembangunan<br /><br />#Masyarakat luas<br /><br />#Lingkungan<br /><br />#Penelitian<br /><br />#Pemecahan masalah', 'e', ''),
(41, 42, 'Maraknya kasus korupsi yang tidak pernah mendapat sanksi yang tegas menyebabkan penyimpangan itu tumbuh subur di hampir semua lapisan masyarakat. Ini termasuk masalah sosial yang didorong oleh faktor&hellip;.<br /><br /><br />', 'Psikologi<br /><br />#Sosiologi<br /><br />#Biologi<br /><br />#Politik<br /><br />#Budaya', 'e', ''),
(42, 42, 'Sebagai seorang artis yang punya jadwal mengisi acara di banyak tempat, selalu membawa Ipad untuk membantu mengingat jadwal kerja dan berbagai hal yang berkaitan dengan keperluan show-nya. Ini menunjukkan bahwa Ipad baginya memiliki nilai....<br /><br />', 'Vital<br /><br />#Logika<br /><br />#Material<br /><br />#Estetika<br /><br />#Spiritual', 'a', ''),
(43, 42, 'Perilaku berjabat tangan saat bertemu teman atau sahabat, menghormati orang yang lebih tua, makan dengan tangan kanan, berpakaian bagus pada waktu pesta serta berjalan kaki di jalur kiri merupakan contoh dari norma&hellip;.<br /><br /><br />', 'Sosial<br /><br />#Tata kelakuan<br /><br />#Custom<br /><br />#Kelaziman<br /><br />#Folkways', 'b', ''),
(44, 42, 'Perhatikan data-data berikut ini!<br />1. Tahap penerimaan kolektif (generalized other)<br />2. Tahap persiapan (preparatory stage)<br />3. Tahap siap bertindak (game stage)<br />4. Tahap meniru (play stage)<br />Tahapan sosialisasi dalam pembentukan kepribadian dari awal sampai terakhir yang benar ditunjukkan dengan nomor&hellip;.<br /><br />', '2, 4, 3, dan 1<br /><br />#2, 4, 1, dan 3<br /><br />#4, 2, 3, dan 1<br /><br />#4, 3, 2, dan 1<br /><br />#3, 4, 1, dan 2', 'a', ''),
...
(49, 42, 'Seorang investor asing ingin membangun perusahaan asing di Indonesia. Ia bekerjasama dengan pengusaha yang ada di Indonesia. Modal usaha berasal dari modal masing-masing yang digabungkan bersama untuk membangun perusahaan. Usaha investor asing ini dikenal dengan istilah&hellip;.', 'Bargaining<br /><br />#Cooptation<br /><br />#Joint venture<br /><br />#Coalition<br /><br />#Accommodation', 'c', ''),
...
(53, 42, 'Beberapa kasus yang dapat ditemukan di kota-kota besar adalah masalah anak jalanan. Beberapa anak jalanan di kota besar menunjukkan adanya ketergantungan mengonsumsi lem, dengan cara dihirup. Efek samping yang timbul adalah adanya rasa tenang untuk sementara waktu, tetapi hal ini dapat merusak jaringan otak dan paru-paru si pengguna. Lembaga berikut ini berperan menanggulangi masalah tersebut secara preventif, kecuali&hellip;.<br /><br /><br />', 'Lembaga agama<br /><br />#Lembaga keluarga<br /><br />#Lembaga pendidikan&nbsp;<br /><br />#Lembaga pengadilan<br /><br />#Lembaga media massa', 'd', ''),
(54, 42, 'Perhatikan variabel berikut!<br />1. Lapisan-lapisan sosial atau stratifikasi sosial<br />2. Lembaga-lembaga sosial atau institusi sosial<br />3. Kaidah-kaidah atau norma-norma sosial<br />4. Kesenjangan sosial<br />5. Integrasi sosial<br />Unsur-unsur pokok struktur sosial ditunjukkan oleh nomor&hellip;.<br /><br /><br />', '1, 2, dan 3<br /><br />#1, 2, dan 4<br /><br />#1, 3, dan 5<br /><br />#2, 4, dan 5<br /><br />#3, 4, dan 5', 'a', ''),
...
(42, '2016-03-12', 'USEK SOSIOLOGI 2014-2015 KODE 01', '4', '0', '0', 'random', '25', 'a,b,c,d,e', 'disabled', '13', '', 'latihan', '', 'admin');
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Administrator', 'aktif', 0, '2015-12-15 08:20:13', '2010-08-27 00:00:00', '2034-08-27 00:00:00', 'Administrator', '', 'sembunyikan', 'sembunyikan', '', '', '0'),
